...
export default function Model(props) {
  const { nodes, materials } = useGLTF(`${process.env.NEXT_PUBLIC_CDN}games/Assets+Gallery/low_poly_building.glb`);
  return (
...
useGLTF.preload(`${process.env.NEXT_PUBLIC_CDN}games/Assets+Gallery/low_poly_building.glb`);